      ...
      <div className="w-full bg-black/30 backdrop-blur-lg border border-white/10 rounded-xl shadow-2xl p-8 space-y-6">
        ...
        >
            <svg className="w-6 h-6" viewBox="0 0 48 48">
                ...
                <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.23,4.142-4.082,5.571l6.19,5.238C41.346,34.773,44,29.865,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
            </svg>
            Sign in with Google
        </button>
      </div>
